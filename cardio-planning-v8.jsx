...
const HELP_SECTIONS=[
 ...
 {id:"onglets",icon:"📑",title:"Les onglets un par un",body:()=>HE("div",null,
  ...
  HTab({t:"📥 Reports",children:["outil individuel et facultatif d'aide au report de consultations : cochez vos semaines blanches, l'application propose les reports (blanches d'abord, puis créneaux à ouvrir), avec export CSV."]}))},
  ...
  return RE("div",{style:{maxWidth:820}},
    ...
    analysis.pairs.length===0
      ...
      :RE("div",{style:{border:"1px solid var(--border)",borderRadius:8,overflow:"hidden",marginBottom:10}},
        analysis.pairs.map((pr,i)=>RE("div",{key:i,style:{display:"flex",alignItems:"center",gap:8,padding:"6px 10px",borderTop:i>0?"1px solid var(--border2)":"none",fontSize:11,flexWrap:"wrap"}},
          RE("span",{style:{fontWeight:800,color:"var(--txt)",minWidth:120}},fmtD(pr.lost)+" "+pr.lost.sl),
          RE("span",{style:{fontSize:9,padding:"1px 6px",borderRadius:5,fontWeight:800,background:pr.lost.why==="tour"?"rgba(29,78,216,.12)":"rgba(239,68,68,.12)",color:pr.lost.why==="tour"?"#1d4ed8":"#ef4444"}},pr.lost.why==="tour"?"tour":"absence"),
